  ...
  return (
    <section className="relative bg-black text-white pt-32 pb-20 px-6 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        >
          We create digital products and experiences that are visually striking,
          user-centric, and built for performance. Explore some of the projects
          we’ve proudly delivered for clients across industries.
        </motion.p>
      </div>
    </section>
  )
