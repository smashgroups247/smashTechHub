...
const brands = [
  {
    ...
    icon: (
      <div className="w-10 h-10 rounded-lg flex items-center justify-center">
        <Image src={assets.smashTechnology_logo} alt='' width={64} height={64} className="object-cover w-full h-full rounded-full" />
      </div>
    ),
    text: (
      <>
  ...
  },
  {
    name: "Qiimeet",
    icon: (
      <div className="justify-center w-10 h-10 flex items-center">
        <Image src={assets.Qiimeet_logo} alt='' width={64} height={64} className="object-cover w-full h-full" />
      </div>
    ),
    text: <span className="text-white font-bold text-2xl">Qiimeet</span>
  },
  {
    name: "Ridesmash",
    icon: (
      <div className="w-10 h-10 rounded-lg flex items-center justify-center">
        <Image src={assets.ridesmash} alt='' width={64} height={64} className="object-cover w-full h-full rounded-full" />
      </div>
    ),
  ...
  },
  {
    ...
    icon: (
      <div className="w-10 h-10 rounded-lg flex items-center justify-center">
        <Image src={assets.smashTravels_logo} alt='' width={64} height={64} className="object-cover w-full h-full rounded-full" />
      </div>
    ),
  ...
  },
  {
    ...
    icon: (
      <div className="w-10 h-10 rounded-lg flex items-center justify-center">
        <Image src={assets.smashMail_logo} alt='' width={64} height={64} className="object-cover w-full h-full" />
      </div>
    ),
  ...
  },
  {
    ...
    icon: (
      <div className="w-10 h-10 rounded-lg flex items-center justify-center">
        <Image src={assets.smashchat} alt='' width={64} height={64} className="object-cover w-full h-full" />
      </div>
    ),
  ...
  },
  {
    ...
    icon: (
      <div className="w-10 h-10 rounded-lg flex items-center justify-center">
        <Image src={assets.paradise} alt='' width={64} height={64} className="object-cover w-full h-full" />
      </div>
    ),
  ...
  },
  {
    ...
    icon: (
      <div className="w-10 h-10 rounded-lg flex items-center justify-center">
        <Image src={assets.smashfood} alt='' width={64} height={64} className="object-cover w-full h-full" />
      </div>
    ),
  ...
  },
  {
    ...
    icon: (
      <div className="w-10 h-10 rounded-lg flex items-center justify-center">
        <Image src={assets.smashLogistics_logo} alt='' width={64} height={64} className="object-cover w-full h-full" />
      </div>
    ),
  ...
  },
  {
    ...
    icon: (
      <div className="w-10 h-10 rounded-lg flex items-center justify-center">
        <Image src={assets.smashwise} alt='' width={64} height={64} className="object-cover w-full h-full" />
      </div>
    ),
    text: <span className="text-white font-bold text-2xl">SmashWise</span>
  },
  {
    name: "SmashApartments",
    icon: (
      <div className="w-10 h-10 rounded-lg flex items-center justify-center">
        <Image src={assets.smashApartment} alt='' width={64} height={64} className="object-cover w-full h-full" />
      </div>
    ),
...
export const Footer = () => {
  return (
    <footer className="bg-black text-white py-14 border-t rounded-t-[20px] sm:rounded-t-[62px] border-white/10">
          ...
          <div className="relative w-full">
            <div className="flex w-max animate-marquee gap-16">
              {[...brands, ...brands].map((brand, index) => (
                <div
                  key={index}
                  className="flex items-center gap-3 min-w-max hover:scale-105 transition-transform duration-300"
                >
                  {brand.icon}
                  {brand.text}
                </div>
