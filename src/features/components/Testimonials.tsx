...
export function Testimonials() {
    ...
    const prev = () => setCurrentIndex((prev) => prev - 1 < 0 ? testimonials.length - 1 : prev - 1)

    return (
        <section className="bg-[#FFF8F5] py-24 rounded-[48px] relative">
            <div className="max-w-screen mx-auto px-6 py-24 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center bg-[#F4E9DA] rounded-t-[48px]">
                ...
                <div className="relative">
                    ...
                    <AnimatePresence mode="wait">
                        <motion.p
                            key={currentIndex}
                            className="mt-10 text-[#333] text-xl leading-relaxed max-w-xl"
                    ...
                    <div className="mt-8">
                        <AnimatePresence mode="wait">
                            ...
                            >
                                <h4 className="text-2xl font-bold text-black">{testimonials[currentIndex].name}</h4>
                                <p className="text-black/60">{testimonials[currentIndex].position}</p>
                            </motion.div>
                        </AnimatePresence>
                    </div>
            ...
            {/* CTA */}
            <div className="max-w-screen mx-auto bg-[#5B6B32] py-20 rounded-b-[48px] flex flex-col md:flex-row justify-between items-center gap-10 px-10">
                <div className="text-white">
                    <h2 className="text-5xl font-bold">Ready To Build Something Amazing</h2>
